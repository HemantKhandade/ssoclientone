package com.hk.sso.clientone.interceptor;
...
public class AppOneInterceptor extends HandlerInterceptorAdapter {

	private static Logger log = LoggerFactory.getLogger(AppOneInterceptor.class);
